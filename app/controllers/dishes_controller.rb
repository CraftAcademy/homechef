class DishesController < ApplicationController
	...
	def create
		...
		@user_dish = Dish.create(name: params[:name], description: params[:description], price: params[:price], portions: params[:portions], ready_time: params[:ready_time], lat:location.lat, lng:location.lng, user: current_user)
